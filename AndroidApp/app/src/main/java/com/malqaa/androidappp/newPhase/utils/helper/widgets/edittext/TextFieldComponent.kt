package com.malqaa.androidappp.newPhase.utils.helper.widgets.edittext
...
//        a.recycle()
    ...
    fun setClickEdt(select: Boolean) {
        etl_Field.isClickable = select
        et_Field.isClickable = select
    }
