...
import com.malqaa.androidappp.newPhase.domain.models.loginResp.BusinessAccountsDetails
...
import com.malqaa.androidappp.newPhase.domain.models.servicemodels.addtocart.CartItemModel
...
import com.malqaa.androidappp.newPhase.domain.models.servicemodels.feedbacks.FeedbackObject
...
class ConstantObjects {
    ...
    companion object {
        ...
        var useraddresses: List<ShippingAddressesData>? = null
