...
import com.malqaa.androidappp.databinding.ItemTechnicalMessageBinding
import com.malqaa.androidappp.newPhase.domain.models.contauctUsMessage.TechnicalSupportMessageDetails
import com.malqaa.androidappp.newPhase.utils.HelpFunctions

class TechnicalSupportListAdapter(
    private var technicalSupportMessageList: List<TechnicalSupportMessageDetails>,
    private var setonClickListeners: SetonClickListeners
) : Adapter<TechnicalSupportListAdapter.TechnicalSupportListViewHolder>() {
    class TechnicalSupportListViewHolder(var viewBinding: ItemTechnicalMessageBinding) :
    ...
    override fun onBindViewHolder(holder: TechnicalSupportListViewHolder, position: Int) {
        holder.viewBinding.tvProblemTitle.text =
            technicalSupportMessageList[position].problemTitle ?: ""
        holder.viewBinding.tvDate.text = HelpFunctions.getViewFormatForDateTrack(
            technicalSupportMessageList[position].createdAt,
            "dd/MM/yyyy HH:mm:ss"
        )
        holder.viewBinding.tvMessageDetails.text =
            technicalSupportMessageList[position].meassageDetails ?: ""
