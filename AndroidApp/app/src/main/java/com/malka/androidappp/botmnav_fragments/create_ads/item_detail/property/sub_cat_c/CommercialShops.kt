...
import kotlinx.android.synthetic.main.fragment_commercial_offices.btncoffices
...
class CommercialShops : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_commercial_shops, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btncshops.setOnClickListener() {
            val floorArea: String = floorAreaS2.getText().toString()
            StaticClassAdCreate.floorarea = floorArea

            findNavController().navigate(R.id.commercialsaleshops_listingdetail)
