package com.malka.androidappp.newPhase.presentation.fragments.nofication_fragments
...
class LogoutNotification : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_logout_notification, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        toolbar_logout_noti.setTitle("Notifications")
        toolbar_logout_noti.setTitleTextColor(Color.WHITE)
        ...
        val myId = tx_noti3.text.toString().trim()
        ...
        tx_noti3.movementMethod = LinkMovementMethod.getInstance()
        tx_noti3.setText(mSpannableString)
