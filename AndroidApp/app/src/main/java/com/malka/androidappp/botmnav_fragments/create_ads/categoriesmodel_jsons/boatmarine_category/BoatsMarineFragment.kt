package com.malka.androidappp.botmnav_fragments.create_ads.categoriesmodel_jsons.boatmarine_category
...
class BoatsMarineFragment : Fragment() , BoatsMarineAdapter.onBoatsmarineClickListener {
 ...
 override fun onItemClick(item : CategoriesItem , position:Int)
 {
     ...
     findNavController().navigate(R.id.boatsmarine_addphoto)
 }
}