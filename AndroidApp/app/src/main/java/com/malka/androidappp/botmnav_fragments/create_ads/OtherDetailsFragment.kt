...
////////////////////////////////////////
    ...
    private fun validateFExpiry(): Boolean {
        val textFExpiry = requireActivity().findViewById(R.id.feauredexpirydate) as TextInputEditText
    ...
    private fun validateUExpiry(): Boolean {
        val textUExpiry = requireActivity().findViewById(R.id.urgentexpirydate) as TextInputEditText
    ...
    private fun validateHExpiry(): Boolean {
        ...
        val textHighLightExpiry = requireActivity().findViewById(R.id.hightlightexdate) as TextInputEditText
