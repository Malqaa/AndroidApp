...
class RecentAdvertisementAdapter(
    val listCar: List<Recentadvetisement>?
) :
    RecyclerView.Adapter<RecentAdvertisementAdapter.CarViewHolder>() {

    var onItemClick: ((Recentadvetisement) -> Unit)? = null
    ...
    override fun onBindViewHolder(holder: CarViewHolder, position: Int) {
        val list: Recentadvetisement = listCar!![position]
        holder.bind(list)
    }
    ...
    inner class CarViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(listCar: Recentadvetisement) {
