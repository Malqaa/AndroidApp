...
import kotlinx.android.synthetic.main.fragment_commercial_workshops.floorAreaW2
...
class CommericalWarehouses : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_commerical_warehouses, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btncwarehouse.setOnClickListener() {
            val floorArea: String = floorAreaWare2.getText().toString()
            StaticClassAdCreate.floorarea = floorArea


            //
            findNavController().navigate(R.id.commercialsalewarehouses_listingdetail)
        }
    }
}
