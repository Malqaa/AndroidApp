...
//                Toast.makeText(context, "Please add a photo", Toast.LENGTH_SHORT).show()
    ...
    fun decisionbyCatandSubCat() {
        if (StaticClassAdCreate.template == "Vehicles") {
            ...
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_generalitemdetails)
        }
    }
    ...
    fun propertyDecision() {
        ...
        if (StaticClassAdCreate.propertySubCatB == "Lands") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_commercialland)
        } else if (StaticClassAdCreate.propertySubCatB == "Shops") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_commercialshops)
        } else if (StaticClassAdCreate.propertySubCatB == "Hotels") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_commercialhotels)
        } else if (StaticClassAdCreate.propertySubCatB == "Factories") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_commercialfactories)
        } else if (StaticClassAdCreate.propertySubCatB == "Offices") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_commercialoffices)
        } else if (StaticClassAdCreate.propertySubCatB == "Workshops") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_commercialworkshops)
        } else if (StaticClassAdCreate.propertySubCatB == "Warehouses") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_commercialwarehouses)
        } else if (StaticClassAdCreate.propertySubCatB == "Agriculture For Sale") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_agricultureforsale)
        } else if (StaticClassAdCreate.propertySubCatB == "Agriculture For Rent") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_agricultureforrent)
        } else if (StaticClassAdCreate.propertySubCatB == "Land") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_residentialland)
        } else if (StaticClassAdCreate.propertySubCatB == "Villas") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_residentialvillas)
        } else if (StaticClassAdCreate.propertySubCatB == "Buildings") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_residentialbuildings)
        } else if (StaticClassAdCreate.propertySubCatB == "Apartments") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_residentialapartments)
        } else if (StaticClassAdCreate.propertySubCatB == "Holiday House") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_residentialholidayhouse)
        }
    ...
    fun decidenextScreenbyTemplate() {
        if (StaticClassAdCreate.template == "AutoMobile") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_otherdetailautomobile)
        } else if (StaticClassAdCreate.template == "General") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_otherlistdeta)
        } else if (StaticClassAdCreate.template == "Property") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_otherlistproperty)
        }
    }
    ...
    fun vehicleDecidenextbySubcategory() {
        if (StaticClassAdCreate.subcat == "Car") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_caritemdetails)
        } else if (StaticClassAdCreate.subcat == "Bus") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_busitemdetails)
        } else if (StaticClassAdCreate.subcat == "Motorbike") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_motorbikeitemdetail)
        } else if (StaticClassAdCreate.subcat == "Trailers") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_trailers)
        } else if (StaticClassAdCreate.subcat == "Diggers") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_listingdetail)
        } else if (StaticClassAdCreate.subcat == "Forklifts & pallet movers") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.add_photo_forlkliftpallet)
        } else if (StaticClassAdCreate.subcat == "Trucks") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_truckitemdetail)
        } else if (StaticClassAdCreate.subcat == "Wrecked car") {
            findNavController(R.id.nav_host_fragment).navigate(R.id.addphoto_wreckcar)
        }
