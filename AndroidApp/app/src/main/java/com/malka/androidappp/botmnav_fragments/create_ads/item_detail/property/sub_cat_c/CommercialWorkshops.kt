...
import kotlinx.android.synthetic.main.fragment_commercial_shops.*
import kotlinx.android.synthetic.main.fragment_commercial_shops.btncshops
...
class CommercialWorkshops : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_commercial_workshops, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btncworkshops.setOnClickListener() {
            val floorArea: String = floorAreaW2.getText().toString()
            StaticClassAdCreate.floorarea = floorArea


            //
            findNavController().navigate(R.id.commercialsaleworkshops_listingdetail)
        }
    }
}
