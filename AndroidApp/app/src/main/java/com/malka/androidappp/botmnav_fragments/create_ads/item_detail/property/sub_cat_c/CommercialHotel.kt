...
import kotlinx.android.synthetic.main.fragment_commercial_factories.*
import kotlinx.android.synthetic.main.fragment_commercial_factories.btncfactories
import kotlinx.android.synthetic.main.fragment_commercial_hotel.*
...
class CommercialHotel : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_commercial_hotel, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnchotels.setOnClickListener() {
            val floorArea: String = floorAreaH2.getText().toString()
            StaticClassAdCreate.floorarea = floorArea

            val landArea: String = LandAreaH2.getText().toString()
            StaticClassAdCreate.landarea = landArea

            //
            findNavController().navigate(R.id.commercialsalehotel_listingdetail)
        }
    }
}
