...
import kotlinx.android.synthetic.main.fragment_agriculture_for_rent.*
import kotlinx.android.synthetic.main.fragment_agriculture_for_rent.btnaforrent
...
class AgricultureForSale : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_agriculture_for_sale, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnAS.setOnClickListener() {
            val floorArea: String = floorAreaAS2.getText().toString()
            StaticClassAdCreate.floorarea = floorArea
            //

            findNavController().navigate(R.id.agriculturesale_listingdetail)
