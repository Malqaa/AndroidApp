...
import kotlinx.android.synthetic.main.fragment_commercial_hotel.btnchotels
...
class CommercialLands : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_commercial_lands, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnclands.setOnClickListener() {
            val floorArea: String = floorAreaL2.getText().toString()
            StaticClassAdCreate.floorarea = floorArea
            findNavController().navigate(R.id.commercialsalelands_listingdetail)
