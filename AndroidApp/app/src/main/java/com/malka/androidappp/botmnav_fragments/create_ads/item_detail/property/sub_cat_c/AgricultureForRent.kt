...
import kotlinx.android.synthetic.main.fragment_bus_sub_cat.btnbus
...
class AgricultureForRent : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_agriculture_for_rent, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnaforrent.setOnClickListener() {
            val floorArea: String = agriculureForRent2.getText().toString()
            StaticClassAdCreate.floorarea = floorArea

            //

            findNavController().navigate(R.id.agriculturerent_listingdetail)
