...
import kotlinx.android.synthetic.main.fragment_logout_watchlish.*


class LogoutWatchlish : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_logout_watchlish, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        toolbar_logout_watchlist.setTitle("Watchlist")
        toolbar_logout_watchlist.setTitleTextColor(Color.WHITE)
        ...
        val myId = tx_watchlist3.text.toString().trim()
        ...
        tx_watchlist3.movementMethod = LinkMovementMethod.getInstance()
        tx_watchlist3.setText(mSpannableString)
