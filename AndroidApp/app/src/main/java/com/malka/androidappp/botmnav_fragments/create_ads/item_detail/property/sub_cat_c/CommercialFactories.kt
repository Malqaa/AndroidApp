...
import kotlinx.android.synthetic.main.fragment_agriculture_for_sale.*
import kotlinx.android.synthetic.main.fragment_agriculture_for_sale.btnAS
...
class CommercialFactories : Fragment() {
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_commercial_factories, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btncfactories.setOnClickListener() {
            val floorArea: String = floorAreaFac2.getText().toString()
            StaticClassAdCreate.floorarea = floorArea

            //


            findNavController().navigate(R.id.commercialsalefactories_listingdetail)
        }
    }
}
